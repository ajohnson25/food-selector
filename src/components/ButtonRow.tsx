...
class Button extends React.Component<ButtonProps> {
  render () {
    return <button className="btn waves-effect waves-light col l4 s12" id={this.props.option.id} onClick={this.props.onClick} value={this.props.option.text}>{this.props.option.text}</button>;
  }
}
