...
INSERT INTO public.food_preference (id, name, short_name) VALUES ('Like', 'like');
INSERT INTO public.food_preference (id, name, short_name) VALUES ('Haven''t Had', 'havent-had');
INSERT INTO public.food_preference (id, name, short_name) VALUES ('Don''t Like', 'dont-like');
...
INSERT INTO public.foods (name, image_file, image_attribution_username, image_attribution_fullname, image_provider_id, id) VALUES ('Orange', 'orange.jpg', '@runblue', 'Xiaolong Wong', 2, 2);
INSERT INTO public.foods (name, image_file, image_attribution_username, image_attribution_fullname, image_provider_id, id) VALUES ('Banana', 'banana.jpg', '@giorgiotrovato', 'Giorgio Trovato', 2, 3);
INSERT INTO public.foods (name, image_file, image_attribution_username, image_attribution_fullname, image_provider_id, id) VALUES ('Pomegranite', 'pomegranite.jpg', '@matyszczyk', 'Marta Matyszczyk', 2, 4);
INSERT INTO public.foods (name, image_file, image_attribution_username, image_attribution_fullname, image_provider_id, id) VALUES ('Coffee', 'coffee.jpg', '@asthetik', 'Mike Kenneally', 2, 5);
INSERT INTO public.foods (name, image_file, image_attribution_username, image_attribution_fullname, image_provider_id, id) VALUES ('Hamburger', 'hamburger.jpg', '@amir_v_ali', 'amirali mirhashemian', 2, 6);
INSERT INTO public.foods (name, image_file, image_attribution_username, image_attribution_fullname, image_provider_id, id) VALUES ('Macaroni and cheese', 'macandcheese.jpg', '@hermez777', 'Hermes Rivera', 2, 7);
INSERT INTO public.foods (name, image_file, image_attribution_username, image_attribution_fullname, image_provider_id, id) VALUES ('Sunny side up eggs', 'sunnysideupeggs.jpg', '@saraheboudreau', 'Sarah Boudreau', 2, 8);
INSERT INTO public.foods (name, image_file, image_attribution_username, image_attribution_fullname, image_provider_id, id) VALUES ('Red Apple', 'apple.jpg', '@louishansel', 'Louis Hansel @shotsoflouis', 2, 1);
INSERT INTO public.foods (name, image_file, image_attribution_username, image_attribution_fullname, image_provider_id, id) VALUES ('Kale', 'kale.jpg', '@charbeck', 'Char Beck', 2, 9);
INSERT INTO public.foods (name, image_file, image_attribution_username, image_attribution_fullname, image_provider_id, id) VALUES ('Tomatoes', 'tomatoes.jpg', '@tomhermans', 'Tom Hermans', 2, 10);
